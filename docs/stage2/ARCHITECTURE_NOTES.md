...
- SEC data only covers registered advisors (excludes true single-family offices which are SEC-exempt)
...
**Final Dataset Stats:**
- 509 qualifying records across 144 firms
...
## 6. Buyer Challenge and Demonstrated Commercial Value
...
**Burden Removed:**
- **Manual research:** Agent decomposes "healthcare mandate fit" into structured queries (counts by mandate/geography) + semantic retrieval (CIO bios) + contact verification (MX-checked emails), then synthesizes a ranked answer with confidence per match.
...
8. **Build Summary:** This document + `BUILD_SUMMARY.md`
...
| Source Classes | 11 | — | ✅ |
| Countries | 4 | — | — |
| Tests Passing | 47/47 | 47 | ✅ |
| Release Gate | Ready | Ready | ✅ |
| Operating Window | 3 runs / 48h+ | 2+ runs / 48h | ✅ |
| CI/CD | All green | All green | ✅ |
